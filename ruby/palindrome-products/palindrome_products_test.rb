...
class PalindromesTest < Minitest::Test
  def test_palindromes_palindrome?
    assert Palindromes.palindrome?(1.digits)
    assert Palindromes.palindrome?(2.digits)
    assert Palindromes.palindrome?(3.digits)
    assert Palindromes.palindrome?(4.digits)
    assert Palindromes.palindrome?(5.digits)
    assert Palindromes.palindrome?(6.digits)
    assert Palindromes.palindrome?(7.digits)
    assert Palindromes.palindrome?(8.digits)
    assert Palindromes.palindrome?(9.digits)
    refute Palindromes.palindrome?(10.digits)
    assert Palindromes.palindrome?(11.digits)
    refute Palindromes.palindrome?(12.digits)
    assert Palindromes.palindrome?(33.digits)
    assert Palindromes.palindrome?(121.digits)
    assert Palindromes.palindrome?(6432346.digits)
    assert Palindromes.palindrome?(9009.digits)
  end
